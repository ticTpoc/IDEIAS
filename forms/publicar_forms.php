...
<tr>
    <td class="content">
     <div class='formulario'>
        ...
        <br><div><label for='texto' id='labelcomentario'>Comentário: </label><textarea  id="texto" name="texto"
          rows="10" cols="70" required> </textarea></div><br>
          <label for='assunto'>Assunto </label><input type='text' name='assunto' id='assunto' required><br><br>
